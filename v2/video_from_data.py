...
filter_data = np.load('filter_run0.npz')
...
def print_step(t):
    plot_particles.set_sizes(7000 * all_weights[t, :, 0])
...
anim = matplotlib.animation.FuncAnimation(fig, print_step, frames=range(1000))

# use FFmpeg to write animation to file
ffmpeg_writer = matplotlib.animation.FFMpegWriter(fps=10)
anim.save('/Users/michael/Desktop/particle_positions.mp4', writer=ffmpeg_writer)
